    ...
    <main className={styles.stage}>
      ...
      <div className={styles.workspace}>
        ...
        <section className={styles.galleryPanel}>
          ...
          <div className={styles.cardWall}><div className={styles.ghostCardA} /><div className={styles.ghostCardB} /><div className={styles.nftCard}><span className={styles.photonA} /><span className={styles.photonB} />{previewImage ? <Image src={previewImage} alt={name || "NFT 作品预览"} fill unoptimized className="object-cover" /> : <div className={styles.emptyArtwork}><Sparkles /><strong>等待作品显影</strong><span>故事和画面方向成熟后，Agent 会自动生成作品</span></div>}<div className={styles.lightScan} /></div></div>
